...
export interface ParliamentBadgesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "badgeCounter"
...
export interface ParliamentBadges extends BaseContract {
  connect(runner?: ContractRunner | null): ParliamentBadges;
  waitForDeployment(): Promise<this>;

  interface: ParliamentBadgesInterface;
  ...
  badgeCounter: TypedContractMethod<[], [bigint], "view">;
